...
for i in range(1):
    ...
    synth_view_settings = {'normal_vector': [0.1*(i+1), 0.08, np.sqrt(1.-(0.1*(i+1)))], #[0.08, 0.08, 0.916],
    ...
    ax1.plot_coord(intensity_coords, color='white', linewidth=0.75)
    ...
    ax2.plot_coord(intensity_coords_, color='white', linewidth=0.75)
    ...
    plt.savefig('xrt_brightness_profile_'+str(i)+'.png')
